 ...
 */
public final class SubstituteRestrain implements PermissionRestrain {
    private static SubstituteRestrain restr = null;

    static SubstituteRestrain getInstance() {
        if(restr == null)restr = new SubstituteRestrain();
        return restr;
    }

    private SubstituteRestrain() {}
