...
public class EditController {
    ...
    protected boolean cancel() {
        ...
        if(!name.getText().equals(initEventDutyDTO.getName())
                ...
                || (date.getValue() != null && !date.getValue().equals(initEventDutyDTO.getEndTime().toLocalDateTime().toLocalDate()))
                || (startTime.getValue() != null && !startTime.getValue().equals(initEventDutyDTO.getStartTime().toLocalDateTime().toLocalTime()))
                || (endTime.getValue() != null && !endTime.getValue().equals(initEventDutyDTO.getEndTime().toLocalDateTime().toLocalTime()))
